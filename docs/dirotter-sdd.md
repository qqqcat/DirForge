# DirOtter 系统设计说明书（SDD，2026-03-16）

## 1. 目标与范围

> 说明：本文件聚焦系统设计与架构目标；项目阶段、风险与优先级请参考 `docs/dirotter-comprehensive-assessment.md`。
...
- 已实现：默认根路径选择、盘符快捷扫描、Inspector 内真实删除（回收站/永久删除确认）、后台删除任务提示、目录上下文文件榜单、文本/CSV/诊断导出。
