...
- **多语言能力已扩展**：设置页现已支持 `中文 / English / Français / Español`，并可按 `zh / fr / es / en` 系统语言环境自动选择默认语言。
...
- **卡片描边裁切根因已修正**：统一卡片容器增加外边距，避免 `egui` 在紧凑子布局中裁掉右边框和下边框。
...
- 设置页语言选项已扩展到中文、英文、法语和西班牙语，核心导航、状态和操作文案已覆盖四语言
