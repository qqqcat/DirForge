...
translation_table!(lookup_fr, {
    ...
    "System path or system-managed file. Deletion is blocked." => "Chemin système ou fichier géré par le système. La suppression est bloquée.",
    ...
    "Safe items are selected by default, warning items stay unchecked, and blocked items remain locked." => "Les éléments sûrs sont sélectionnés par défaut, les avertissements restent décochés et les éléments bloqués restent verrouillés.",
...
translation_table!(lookup_es, {
    ...
    "System path or system-managed file. Deletion is blocked." => "Ruta del sistema o archivo gestionado por el sistema. La eliminación está bloqueada.",
    ...
    "Safe items are selected by default, warning items stay unchecked, and blocked items remain locked." => "Los elementos seguros se seleccionan por defecto, los de advertencia quedan sin marcar y los bloqueados siguen bloqueados.",
