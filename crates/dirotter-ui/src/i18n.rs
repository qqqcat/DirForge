...
translation_table!(lookup_fr, {
    ...
    "This section keeps brand semantics and current state together instead of splitting them into disconnected cards." => "Cette section garde ensemble la sémantique de marque et l'état actuel au lieu de les disperser dans des cartes déconnectées.",
    ...
    "River Teal" => "River Teal",
    "Primary brand accent for key actions, selection, and emphasis." => "Accent principal de la marque pour les actions clés, la sélection et la mise en valeur.",
    "Base Surfaces" => "Surfaces de base",
    "Kept low-contrast so long sessions stay easy on the eyes." => "Le contraste reste faible pour préserver le confort visuel sur la durée.",
    "Warm Accent" => "Accent chaud",
    "Used sparingly to soften the palette, not dominate it." => "Utilisé avec parcimonie pour adoucir la palette, sans la dominer.",
    "Current Mode" => "Mode actuel",
    "Dark theme is enabled: better for extended scanning and file-size comparison." => "Le thème sombre est activé : mieux adapté aux longues analyses et à la comparaison des tailles.",
    "Light theme is enabled: low contrast and softer luminance to avoid harsh white surfaces." => "Le thème clair est activé : faible contraste et luminance plus douce pour éviter des surfaces blanches agressives.",
...
translation_table!(lookup_es, {
    ...
    "This section keeps brand semantics and current state together instead of splitting them into disconnected cards." => "Esta sección mantiene juntas la semántica de marca y el estado actual en lugar de repartirlas en tarjetas desconectadas.",
    ...
    "River Teal" => "River Teal",
    "Primary brand accent for key actions, selection, and emphasis." => "Acento principal de marca para acciones clave, selección y énfasis.",
    "Base Surfaces" => "Superficies base",
    "Kept low-contrast so long sessions stay easy on the eyes." => "Se mantiene con bajo contraste para que las sesiones largas sean más descansadas.",
    "Warm Accent" => "Acento cálido",
    "Used sparingly to soften the palette, not dominate it." => "Se usa con moderación para suavizar la paleta, no para dominarla.",
    "Current Mode" => "Modo actual",
    "Dark theme is enabled: better for extended scanning and file-size comparison." => "El tema oscuro está activado: mejor para escaneos largos y comparación de tamaños.",
    "Light theme is enabled: low contrast and softer luminance to avoid harsh white surfaces." => "El tema claro está activado: bajo contraste y luminancia más suave para evitar superficies blancas agresivas.",
